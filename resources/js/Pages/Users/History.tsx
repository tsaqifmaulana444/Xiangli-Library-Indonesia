                      ...
                      <tr key={borrow.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        ...
                        <td className="px-6 py-4 text-center">
                          {borrow.status === 'Waiting' ? (
                            ...
                            <button type="button" className="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" onClick={() => doneBorrow(borrow.id)}>Done</button>
                          )}
