                    ...
                    {borrows.length === 0 ? (
                      ...
                      borrows.map((borrow, index) => (
                        <tr key={borrow.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          ...
                          <td className="px-6 py-4 text-center">
                            {borrow.status == 'Done' && borrow.is_giving_rating == false ? (
                            ...
                            ) : borrow.status == 'Done' && borrow.is_giving_rating == true ? (
                              <div className="text-yellow-400 font-bold">{t("add11")}</div>
                            ) : (
                              <>
                                {t("add10")}
                              </>
