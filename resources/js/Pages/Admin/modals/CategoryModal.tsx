                    ...
                    <div className="w-full py-7">
                        ...
                        <form className="mx-auto mt-5" onSubmit={storeCategory}>
                            <div className="mb-5">
                                ...
                                <input type="name" id="name" name="name" value={name} onChange={(e) => setName(e.target.value)}className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Category name" required />
                            </div>
                            <div className="flex">
