                    ...
                    <div className="w-full py-7 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 100px)' }}>
                        ...
                        <form className="mx-auto mt-5" onSubmit={storeBook}>
                            <div className="mb-5">
                                ...
                                <input autoComplete='off' type="text" id="name" name="name" value={name} onChange={(e) => setName(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Book title" required />
                            </div>
                            <div className="mb-5">
